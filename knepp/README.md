...
An additional backup script copies all files nightly over to the backup server downstairs in the SHL Digital lab's physcial space. It requires that the rsync user (in the script itself) have an ssh key set up to log in to the lab computer.
